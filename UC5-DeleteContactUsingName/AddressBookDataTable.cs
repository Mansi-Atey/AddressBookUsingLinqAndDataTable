...
namespace UC5_DeleteContactUsingName
{
    class AddressBookDataTable
    {
        ...
        {
            var contacts = table.AsEnumerable().Where(r => r.Field<string>("FirstName") != "Mansi").CopyToDataTable();
            Console.WriteLine("Following Contacts are present in Datatable after deletion of Contact of Person 'Mansi' ");
